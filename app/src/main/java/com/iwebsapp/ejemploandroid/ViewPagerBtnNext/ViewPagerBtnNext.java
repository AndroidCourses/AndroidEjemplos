package com.iwebsapp.ejemploandroid.ViewPagerBtnNext;
...
public class ViewPagerBtnNext extends AppCompatActivity {
    ViewPager viewPager;
    Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_pager_btn_next);
